...
export const signup = async (req, res) => {
  try {
    const { firstName, lastName, mobile, email, password, shopName, shopType, address, gstin } =
      req.body;
...
export const updateProfile = async (req, res) => {
  try {
    ...
    const { firstName, lastName, email, mobile, shopName, shopType, address, gstin } = req.body;
